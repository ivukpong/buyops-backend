...
export declare class TransactionsService {
    ...
    sendCommissionsForPayment(transactionIds: string[]): Promise<import(".prisma/client").Prisma.BatchPayload>;
    uploadPaymentProof(file: Express.Multer.File): Promise<{
        message: string;
        count: number;
    }>;
    private updateAgentStatsAfterTransaction;
}
